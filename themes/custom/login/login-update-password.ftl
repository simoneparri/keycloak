    ...
    <#elseif section = "form">
        <form id="kc-passwd-update-form" class="${properties.kcFormClass!}" action="${url.loginAction}" method="post">
            ...
            <div class="${properties.kcFormGroupClass!}">
                <div class="${properties.kcLabelWrapperClass!} password-container">
                ...
                <div class="${properties.kcInputWrapperClass!}">
                    ...
                    />
                    <i id="eye-new" class="fa-solid fa-eye fa-lg" style="top: 35%"></i>
            ...
            <div class="${properties.kcFormGroupClass!}">
                ...
                <div class="${properties.kcInputWrapperClass!}">
                    ...
                    />
                    <i id="eye-confirm" class="fa-solid fa-eye fa-lg" style="top: 35%"></i>
